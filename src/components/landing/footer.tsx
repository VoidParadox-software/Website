    ...
    <footer className="bg-[hsl(213_39%_8%)] border-t border-border/50">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 text-center lg:text-left">
          ...
          <div className="space-y-4 flex flex-col items-center lg:items-start">
            ...
            <p className="text-muted-foreground max-w-sm">
                We transform homes into intelligent ecosystems with Cierra technology - the first smart home device with AI that learns and anticipates your needs.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:col-span-2 gap-8">
            <div>
              <h3 className="font-headline font-semibold text-foreground">Products</h3>
            ...
            <div>
             ...
             <div>
              ...
              <ul className="mt-4 space-y-3">
                  {contact.map((item) => (
                      <li key={item.name} className="flex items-center justify-center lg:justify-start gap-3">
                          <item.icon className="w-5 h-5 text-primary flex-shrink-0" />
                          <a href={item.href} className="text-muted-foreground hover:text-primary transition-colors">{item.name}</a>
                      </li>
                  ))}
              </ul>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-border/50 flex flex-col sm:flex-row justify-between items-center text-sm text-muted-foreground gap-6">
          <p>&copy; {new Date().getFullYear()} VoidParadox. All rights reserved.</p>
